...
- **Styling**: Tailwind CSS with custom glass-morphism configurations.
- **Animations**: Framer Motion for staggered list reveals and interactive buttons.
...
- `context/` - React contexts for Auth, Language, Theme
- `pages/` - Route pages (Admin, Member, Profile, etc.)
- `services/` - Supabase client and DB helpers
