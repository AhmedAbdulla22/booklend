        ...
        <div className="flex flex-col items-center text-center">
          <div className="relative mb-4 group">
            <img 
              ...
              alt="Profile" 
              className="w-32 h-32 rounded-full object-cover border-4 border-white/50 dark:border-slate-700/50 shadow-lg"
            />
            {!isEditing && (
          ...
          {isEditing ? (
            ...
            <>
              <h2 className="text-2xl font-bold text-slate-800 dark:text-white">{user.full_name}</h2>
              <p className="text-slate-500 dark:text-slate-400">{user.email}</p>
              
              <div className="mt-4 flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-sm font-medium">
                <Shield size={14} />
          ...
          <div className="w-full grid grid-cols-2 gap-4 mt-8 pt-6 border-t border-slate-200 dark:border-slate-700">
            <div className="text-center">
              <p className="text-3xl font-bold text-slate-800 dark:text-white">{activeCount}</p>
              <p className="text-xs text-slate-500 uppercase tracking-wider">{t('active_loans')}</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-slate-800 dark:text-white">{returnedCount}</p>
