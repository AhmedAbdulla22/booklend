...
export const TRANSLATIONS = {
  en: {
    ...
    late_return_title: 'Late Return Notice',
    late_return_urgent: 'URGENT',
    ...
    log_return_confirmed: "Return Confirmed",
    log_user_promoted: "User Promoted",
    ...
    error_book_has_active_loans: "Cannot delete this book because it is currently borrowed by someone.",
    log_book_deleted: "Book Removed",
    error_deleting_book: "An error occurred while trying to delete the book.",
  },
  ar: {
    by: 'بواسطة',
    app_name: 'إعارة كتب',
    ...
    late_return_title: 'تنبيه: إرجاع متأخر',
    late_return_urgent: 'هام: يجب إرجاع الكتاب في أقرب وقت ممكن',
    ...
    log_return_confirmed: 'تم تأكيد الإرجاع',
    log_user_promoted: 'تمت ترقية المستخدم',
    log_user_deleted: 'تم حذف المستخدم',
    confirm_delete_book: "هل أنت متأكد من حذف هذا الكتاب؟",
    book_deleted_success: "تم حذف الكتاب بنجاح",
    error_book_has_active_loans: "لا يمكن حذف الكتاب لأنه مستعار حالياً من قبل مستخدم.",
    log_book_deleted: "تم إزالة كتاب",
    error_deleting_book: "حدث خطأ أثناء محاولة حذف الكتاب.",
  },
  ku: {
    app_name: 'BookLend',
    dashboard: 'داشبۆرد',
    ...
    user_active: 'چالاک',
    user_idle: 'چالاک نیە',
    table_user: 'بەکارهێنەر',
    table_status_role: 'دۆخ و ڕۆڵ',
    table_actions: 'کردارەکان',
    search_users: 'گەڕان بە بەکارهێنەران...',
    users_tab: 'بەکارهێنەران',
    healthy_stock: 'کۆگای ساغ',
    all_caught_up: 'هەمووی تەواوە!',
    loan_pending: 'چاوەڕوان',
    loan_active: 'چالاک',
    loan_overdue: 'دواکەوتوو',
    loan_returned: 'گەڕێندراوە',
    loan_rejected: 'ڕەتکراوە',
    loan_user_prefix: 'بەکارهێنەر:',
    ...
    genre_classic: 'کلاسیک',
    genre_drama: 'دراما',
    genre_dystopian: 'دیستۆپیا',
    genre_fable: 'چیرۆک',
    ...
    late_return_title: 'ئاگاداری: گەڕاندنەوەی دواکەوتوو',
    late_return_urgent: 'گرنگ: پێویستە کتێبەکە لە کاتی زوودا بگەڕێنرێتەوە',
    ...
    log_return_confirmed: "گەڕاندنەوەکە پشتڕاستکرایەوە",
    log_user_promoted: "بەکارهێنەر بەرزکرایەوە",
    log_user_deleted: "بەکارهێنەر سڕایەوە",
    by: 'لەلایەن',
    confirm_delete_book: "ئایا دڵنیایت لە سڕینەوەی ئەم کتێبە؟",
    book_deleted_success: "کتێبەکە بە سەرکەوتوویی سڕایەوە",
    error_book_has_active_loans: "ناتوانیت ئەم کتێبە بسڕیتەوە چونکە ئێستا لەلایەن کەسێکەوە بە قەرز براوە.",
    log_book_deleted: "کتێبەکە لادرا",
    error_deleting_book: "هەڵەیەک ڕوویدا لە کاتی سڕینەوەی کتێبەکە.",
  }
};
